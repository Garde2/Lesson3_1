...
4. Отправить нашу локальную репу на удаленную .

git push (адрес через ПКМ с Code на гитхабе)

5. Провести изменения с другого компа (просто с гитхаба).

выбираем файл, тыкаем Edit

6. Выкачать с гитхаба в нашу домашнюю репунекий другой репо, используя:
